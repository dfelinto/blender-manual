...
Properties can be set up and initialised in the Properties panel of the Logic Editor - see the
:doc:`Property Editing </game_engine/logic/properties/editing>` page for details.
