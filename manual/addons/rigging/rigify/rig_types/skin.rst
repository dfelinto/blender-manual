...
Spherical Falloff
   A checkbox to change the shape of the falloff curve from a power curve that at falloff 1 forms a parabola
...
This rig in concept similar to ``skin.anchor``, but instead of overriding controls,
